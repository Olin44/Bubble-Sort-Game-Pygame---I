...
class Game:
    def __init__(self):
        ...
        self.background_image = pygame.image.load("graphics/fail.png")
        ...
        mb_position = (280, 400)
        menu_button = Button("S", mb_position, mb_position, self.SCALE)
    ...
    def main_loop(self):
        while True:
            ...
            if self.end_game == 1:
                self.background_image = Resize(pygame.image.load("graphics/chest.png")).get_img()
                self.draw_board()
                print(self.buttons)
                self.event_loop()
            print(self.end_game)
